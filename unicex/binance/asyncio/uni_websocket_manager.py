...
class UniWebsocketManager(IUniWebsocketManager):
    ...
    def klines(self, callback: CallbackType, symbol: str, timeframe: Timeframe) -> Websocket:
    ...
    def futures_klines(
        self, callback: CallbackType, symbol: str, timeframe: Timeframe
    ) -> Websocket:
    ...
    def trades(self, callback: CallbackType, symbol: str) -> Websocket:
        ...
        return self._websocket_manager.trade(callback=wrapper, symbol=symbol)

    def aggtrades(self, callback: CallbackType, symbol: str) -> Websocket:
        ...
        return self._websocket_manager.agg_trade(callback=wrapper, symbol=symbol)

    def futures_trades(self, callback: CallbackType, symbol: str) -> Websocket:
        ...
        return self._websocket_manager.futures_trade(callback=wrapper, symbol=symbol)

    def futures_aggtrades(self, callback: CallbackType, symbol: str) -> Websocket:
        ...
        return self._websocket_manager.futures_agg_trade(callback=wrapper, symbol=symbol)
