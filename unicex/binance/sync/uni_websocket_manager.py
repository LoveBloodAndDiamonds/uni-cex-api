...
class UniWebsocketManager(IUniWebsocketManager):
    ...
    def _adapter_wrapper(self, raw_msg: dict, adapter_func: Callable, callback: Callable) -> None:
    ...
    def klines(self, callback: Callable, symbol: str, timeframe: Timeframe) -> Websocket:
        ...
        return self._socket_manager.klines(
            callback=lambda raw_msg: self._adapter_wrapper(
                raw_msg, self._adapter.klines_message, callback
            ),
            symbol=symbol,
    ...
    def trades(self, callback: Callable, symbol: str) -> Websocket:
        ...
        return self._socket_manager.trade(
            callback=lambda raw_msg: self._adapter_wrapper(
                raw_msg, self._adapter.trades_message, callback
            ),
            symbol=symbol,
        )
