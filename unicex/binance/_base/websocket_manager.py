...
from unicex.binance.asyncio.client import Client as AsyncClient
from unicex.binance.asyncio.user_websocket import UserWebsocket as AsyncUserWebsocket
from unicex.binance.sync.client import Client
from unicex.binance.sync.user_websocket import UserWebsocket
...
class BaseWebsocketManager(Generic[TClient, TWebsocket, TUserWebsocket]):
    ...
    def agg_trade(self, callback: Callable[[Any], Awaitable[None]], symbol: str) -> TWebsocket:
    ...
    def depth_stream(self, callback: Callable[[Any], Awaitable[None]], symbol: str) -> TWebsocket:
    ...
    def mini_ticker(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
    ...
    def symbol_ticker(self, callback: Callable[[Any], Awaitable[None]], symbol: str) -> TWebsocket:
    ...
    def ticker(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
    ...
    def avg_price(self, callback: Callable[[Any], Awaitable[None]], symbol: str) -> TWebsocket:
    ...
    def book_ticker(self, callback: Callable[[Any], Awaitable[None]], symbol: str) -> TWebsocket:
    ...
    def user_data_stream(self, callback: Callable[[Any], Awaitable[None]]) -> TUserWebsocket:
    ...
    def futures_trade(self, callback: Callable[[Any], Awaitable[None]], symbol: str) -> TWebsocket:
        """Создает вебсокет для получения сделок."""
    ...
    def futures_mini_ticker(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
        """Создает вебсокет для получения мини-статистики всех тикеров за последние 24 ч. (Не за сутки)."""
    ...
    def futures_ticker(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
        """Создает вебсокет для получения расширенной статистики всех тикеров за последние 24 ч. (Не за сутки)."""
    ...
    def all_liquidation_orders(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
    ...
    def futures_contract_info(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
    ...
    def futures_multi_assets_index(self, callback: Callable[[Any], Awaitable[None]]) -> TWebsocket:
