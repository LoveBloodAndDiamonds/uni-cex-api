...
- Отрефачить клиент hyperliquid
- Привести всю документацию к единому стилю и задать ее через агента
- round_price и round_quantity пусть возвращают str
- Исправить таблицу в README.md
- Помечать свечи закрытыми в адаптере при rest
...
** Сделано: **
+ единый стиль названий аттрибутов в types
+ по всей видимости можно добавить новый эндпоинт который отвечает за время делистинга пар USDT на фьючах (точно есть на бинансе и байбите)
